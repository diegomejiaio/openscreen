const LATEST_RELEASE_API = "https://api.github.com/repos/diegomejiaio/openscreen/releases/latest";
const OFFICIAL_RELEASE_PREFIX = "/diegomejiaio/openscreen/releases/tag/";
